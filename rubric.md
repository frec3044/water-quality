...
- Full Credit: Correct function with all the required arguments. Returns the URL

- Partial Credit: Incorrect function, missing arguments, or other issue with code
...
- Full Credit: All answers correct for the different maps are provided

- Partial Credit: Missing or incorrect responses for half the maps
...
- Full Credit: Correct data are shown from the use of the function in Question 7

- Partial Credit: Incorrect data frame or no data frame produced

- No Credit: No code or answer provided

Question 9:

- Full Credit: Plot with datetime on the x-axis, nitrate on the y-axis, and a horizontal line at the EPA concentration. Axes labeled

- Partial Credit: Plot has incorrect axes values or labels, missing horizontal line, or other issue
...
- Full Credit: Plot with datetime on the x-axis and the number of days over the limit on the y-axis. Axes labeled

- Partial Credit: Plot has incorrect axes values, labels, or other issues
...
-   No Credit: Assignment in the course GitHub organization, but no commits by the student are on GitHub.
