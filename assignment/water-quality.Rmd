...
url <- paste0("https://nwis.waterdata.usgs.gov/usa/nwis/uv/?",
              ...
              site_no,"&period=&begin_date=", begin_date, "&end_date=",end_date)
```
...
Download data  Then Combine all cleaning steps above into a single set of piped commands that creates a data table named `stream_data`
