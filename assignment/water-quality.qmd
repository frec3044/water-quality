...
the period between `2011-01-01` and `2023-01-01`. The variable code for
nitrate is `cb_99133`.
...
function from question 6.  Use the function `head()` to show your data.
...
this question using skills that you already have (these many include, but are not limited to, `group_by()`,
`summarize()`, `year()`) and some creativity.
...
is higher than the EPA limit (x = year, y = number of days per year).
