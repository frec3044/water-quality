...
Modify the functions we created for downloading and cleaning temperature data to download and clean nitrate data for the period from `2011-01-01` to the current date. The variable code for nitrate is `cb_99133`.
