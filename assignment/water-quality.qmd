...
Modify the functions that we created for downloading and cleaning temperature data to download and clean the nitrate data for the period between `2011-01-01` and the current date. The variable code for nitrate is `cb_99133`.
